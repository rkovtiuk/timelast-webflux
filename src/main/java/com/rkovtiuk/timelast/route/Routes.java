...
public class Routes {
    ...
    // FIXME: 11.12.17 Remove this bean in future
    @Bean
    public RouterFunction<ServerResponse> testRoutes(TweetHandler tHandler, UserHandler uHandler) {
        return RouterFunctions
                .route(GET("/test/tweets/add").and(accept(APPLICATION_JSON)), tHandler::test)
                .andRoute(GET("/test/users/add").and(accept(APPLICATION_JSON)), uHandler::create);
    }
